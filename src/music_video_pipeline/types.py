...
class ModuleBOutputItem(TypedDict):
    ...
    video_prompt_zh: str
    video_prompt_en: str
    keyframe_prompt_start_tokens_zh: NotRequired[list[dict[str, Any]]]
    keyframe_prompt_start_tokens_en: NotRequired[list[dict[str, Any]]]
    keyframe_negative_prompt_start_tokens_zh_increment: NotRequired[list[dict[str, Any]]]
    keyframe_negative_prompt_start_tokens_en_increment: NotRequired[list[dict[str, Any]]]
    keyframe_negative_prompt_start_tokens_zh: NotRequired[list[dict[str, Any]]]
    keyframe_negative_prompt_start_tokens_en: NotRequired[list[dict[str, Any]]]
    keyframe_prompt_end_tokens_zh: NotRequired[list[dict[str, Any]]]
    keyframe_prompt_end_tokens_en: NotRequired[list[dict[str, Any]]]
    keyframe_negative_prompt_end_tokens_zh_increment: NotRequired[list[dict[str, Any]]]
    keyframe_negative_prompt_end_tokens_en_increment: NotRequired[list[dict[str, Any]]]
    keyframe_negative_prompt_end_tokens_zh: NotRequired[list[dict[str, Any]]]
    keyframe_negative_prompt_end_tokens_en: NotRequired[list[dict[str, Any]]]
    video_prompt_tokens_zh: NotRequired[list[dict[str, Any]]]
    video_prompt_tokens_en: NotRequired[list[dict[str, Any]]]
    camera_plan_preset_id: NotRequired[str]
    transition_plan_preset_id: NotRequired[str]
