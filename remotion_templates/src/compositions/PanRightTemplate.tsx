...
export const PanRightTemplate = (props: PanRightTemplateRequest): ReactElement => {
  ...
  const SCALE = 1.125;
  // Phase 1: 快速右移到第二张左边界和视频左边界对齐
  const phase1Dist = W * (3 - SCALE) / 2;  // 0.9375W
  ...
  return (
    <AbsoluteFill style={{width: W, height: H, overflow: "hidden", filter: "grayscale(100%)"}}>
      <AbsoluteFill style={{transform: `translateX(${tx}px)`}}>
        ...
        {/* 新场景在右方（9/8 缩放，垂直居中） */}
        <AbsoluteFill style={{left: W, width: W, height: H, transform: "scale(1.125)", transformOrigin: "center center"}}>
